  ...
  <div class="row">
    <div class="col-md-3">
     <ul class="nav nav-pills nav-stacked">
        ...
        while ($row = mysqli_fetch_array($result_categories)) {
          $id = $row['id'];
          $name = $row['name'];
          echo "<li><a href='adminquestion.php?c_id=$id&c_name=$name'>".$row['name']."</a></li>";
        }
        // set the pointer back to the beginning
        mysqli_data_seek($result_categories, 0);
         ?>
         <a href="addcat.php" class="btn btn-default"> ADD Category </a>
     </ul>
    </div>
    <div class="col-md-9 main_content">
      <h2><?php echo "Category: ".$_GET['c_name']; ?></h2>
       ...
       <h2 class="questiontitle"> <a href="adminques.php?q_id=<?php echo $id; ?>"> <?php echo $title; ?> </a> </h2>
